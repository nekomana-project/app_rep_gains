...
const DismissKeyboardView = ({ children }: { children: React.ReactNode }) => {
  if (Platform.OS === 'web') {
    return <>{children}</>; // On web, just return the content without the touch wrapper
  }
  return (
...
// ==========================================
  ...
  return (    
    <KeyboardAvoidingView 
      style={{ flex: 1 }} 
      // Disable it entirely for web to let the browser handle it
...
const styles = StyleSheet.create({
  ...
  input: { backgroundColor: '#F8FAFC', padding: 16, marginBottom: 20, borderRadius: 16, fontSize: 16, color: '#1E293B', fontWeight: '600', borderWidth: 1, borderColor: '#E2E8F0',  zIndex: 10,elevation: 10},
